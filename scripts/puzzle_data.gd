...
static func _yellow_pool() -> Array:
	return [
		...
		["Krije se broj",          ["stotina", "tisućnjak", "dvopek", "jednina"],           3, "wordplay"],
		...
		["Krije se mak",           ["zamak", "odmak", "umak", "pomak"],                     3, "wordplay",  ["mak", "pomak"]],
		...
		["Krije se rat",           ["vrata", "karate", "pirat", "obrat"],                   3, "wordplay",  ["rat", "vrata"]],
...
static func _green_pool() -> Array:
	return [
		...
		["Rječnik putovanja",      ["viza", "putovnica", "kovčeg", "tranzit"],                 1, "obvious"],
		# --- rank 2 ---
		...
		["Dalmatinska jela",       ["crni rižoto", "gregada", "buzara", "soparnik"],           2, "thematic"],
		...
		["Homonimi",               ["rod", "rok", "klin", "kvaka"],                        3, "wordplay",  ["rok"]],
...
static func _blue_pool() -> Array:
	return [
		...
		["Homonimi",               ["list", "grad", "kos", "pas"],                         1, "wordplay",  ["list", "grad", "kos", "pas"]],
		# --- rank 2 ---
		...
		["Astronomski pojmovi",    ["crna rupa", "pulsar", "kvasar", "maglica"],           2, "thematic"],
		...
		["Crvena ___",             ["nit", "karta", "knjiga", "vrpca"],                    2, "wordplay"],
		...
		["Hrvatska mjesta",        ["Zelina", "Zlatar", "Bijelo Brdo", "Crna Mlaka"],      3, "wordplay"],
		["Europske prijestolnice bez slova a",   ["Beč", "Rim", "Bern", "Oslo"],          3, "wordplay"],
		["Skrivena životinja",     ["kompas", "klavir", "praksa", "evolucija"],            3, "wordplay"],
...
static func _purple_pool() -> Array:
	return [
		...
		["Zlatna ___",             ["groznica", "sredina", "ribica", "medalja"],           2, "wordplay"],
		["Ženska imena i pojmovi", ["Vjera", "Sloboda", "Nada", "Zora"],                  2, "wordplay"],
		["Crna ___",               ["burza", "magija", "kronika", "lista"],               2, "wordplay"],
		...
		["Mogu slijediti: ZLATNI", ["okvir", "rez", "fond", "standard"],                   2, "wordplay"],
		...
		# --- rank 3 ---
		["Mogu biti živi/e",       ["biće", "srebro", "meso", "pitanje"],                 3, "wordplay"],
		...
		["Homonimi",               ["bit", "mast", "vez", "kosa"],                        3, "wordplay",  ["kosa"]],
		...
		["Skrivena Ana",           ["banana", "kanal", "ranac", "fontana"],               3, "wordplay",  ["ana", "banana"]],
		...
		["Završavaju dijelom tijela", ["tvrdoglav", "dugonog", "miloruk", "crnook"],       3, "wordplay"],
		["Palindromi",             ["kuk", "topot", "ratar", "potop"],                      3, "wordplay"],
		["Krije se dio tijela",           ["naručje", "nosač", "rukohvat", "zubarica"],    3, "wordplay"],
		...
		["Krije se broj",                 ["osamnaest", "devetina", "sedamdeset", "desetak"], 3, "wordplay"],
		...
		["Krije se mir",               ["primirje", "mirovina", "miris", "smiriti"],      3, "wordplay",  ["mir"]],
		["Krije se sol",               ["resolutan", "rasol", "parasol", "resolucija"],   3, "wordplay",  ["sol"]],
		["Skrivena Toni",              ["antonim", "plutonij", "fotoni", "monotonija"],   3, "wordplay",  ["toni"]],
		["Krije se pet",               ["apetit", "kapetanica", "tapetirati", "upetljati"], 3, "wordplay", ["pet"]],
	]
