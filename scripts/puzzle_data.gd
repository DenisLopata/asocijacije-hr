...
static func _purple_pool() -> Array:
	return [
		...
		["Lingvistički univerzali",["arbitrarnost", "produktivnost", "pomak", "dvostruka artikulacija"], 3, "thematic"],
		...
		["Krije se broj (teži)",          ["osmica", "devetina", "sedmero", "desetak"],    3, "wordplay"],
